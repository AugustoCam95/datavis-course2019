// https://observablehq.com/@augustocam95/homicidios-em-fortaleza-em-2012@116
...
d3.csv("https://gist.githubusercontent.com/emanueles/8ee225792454a78151d0842a10642a29/raw/9984e32effa99da3cea2ec87a7c9b7b231c71d3c/fortaleza_crimes_populacao.csv").then(function(data) {
    ...
    data.forEach(function(d) {
       if (+d.Populacao>0)
         populationByName.set(d.Bairro, (+d.Populacao)/100000);
         homicidiosByName.set(d.Bairro,(+d.Homicidios)/populationByName.get(d.Bairro))
       if (+d.Populacao<0)
         homicidiosByName.set(d.Bairro,0)
        })
    return homicidiosByName
  })
)});
