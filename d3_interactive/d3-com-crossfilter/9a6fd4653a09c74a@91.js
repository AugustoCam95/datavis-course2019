...
md`${container()}`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["magnitudeChart","magDimension","magDimensionCount","d3","updateMarkers","depthChart","depthDimension","depthDimensionCount","timeChart","hourDimension","hourDimensionCount","dataset","dataTable","dateDimension","dc","map","updateFilters"], function(magnitudeChart,magDimension,magDimensionCount,d3,updateMarkers,depthChart,depthDimension,depthDimensionCount,timeChart,hourDimension,hourDimensionCount,dataset,dataTable,dateDimension,dc,map,updateFilters)
{
