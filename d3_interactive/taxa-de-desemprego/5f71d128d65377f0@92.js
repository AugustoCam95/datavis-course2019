...
md`# Taxa de desemprego nos EUA em agosto de 2016 (Parte 2)`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["d3","DOM","topojson","us","colorScale","rateById","showTooltip","hideTooltip","namesById"], function(d3,DOM,topojson,us,colorScale,rateById,showTooltip,hideTooltip,namesById)
{
  const width = 960
  const height = 600
...
d3.tsv("https://gist.githubusercontent.com/emanueles/7fbdcd8ee412e3e63904114cf9d7ee3a/raw/af4fd93db1be3f9033caff46d4a574a54bf9363f/unemployment.tsv").then(function (data) {
  ...
  main.variable(observer("namesById")).define("namesById", ["d3"], function(d3){return(
...
d3.json("https://gist.githubusercontent.com/emanueles/ee2997bc6237f3dcab952ae8becaf6bf/raw/afdb12d4ef89bb239998b295c94d960e8d89c19e/us.json")
  ...
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","rateById","namesById"], function(d3,rateById,namesById){return(
