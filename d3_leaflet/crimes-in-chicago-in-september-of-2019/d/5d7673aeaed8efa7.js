...
html`<code>css</code> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.0/css/bootstrap.min.css" integrity="sha384-PDle/QlgIONtM1aqA2Qemk5gPOE7wFq8+Em+G/hmo5Iq0CCmYZLv3fVRDJ4MMwEA" crossorigin="anonymous"><link rel="stylesheet" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css"integrity="sha512-xwE/Az9zrjBIphAcBb3F6JVqxf46+CDLwfLMHloNu6KEQCAWi6HcDUbeOfBIptF7tcCzusKFjFw2yuvEpDL9wQ=="crossorigin=""/>`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["md","container","dc","d3","dimCrime","groupCrime","colorScale","dimDay","groupDayCrime","crimes"], function(md,container,dc,d3,dimCrime,groupCrime,colorScale,dimDay,groupDayCrime,crimes)
{
...
d3.csv('https://gist.githubusercontent.com/emanueles/13dfe2c1d43e11b5207bb4e6125d71bf/raw/41d14f8fbd9d6cd9e8ad074f8417cff1329ab339/chicago_crimes_sept_2019.csv').then(function(data){
    var time_format = d3.utcParse("%m/%d/%Y");
	  	data.forEach(function(d){
	  		d.dtg = time_format(d.Date.substr(0,10));
	  		d.lat = d.Latitude;
	  		d.long = d.Longitude;
...
crossfilter(crimes)
  ...
  main.variable(observer("dimDate")).define("dimDate", ["facts"], function(facts){return(
facts.dimension(d => d.dtg)
)});
  main.variable(observer("dimCrime")).define("dimCrime", ["facts"], function(facts){return(
facts.dimension(d => d.type)
)});
  main.variable(observer("groupCrime")).define("groupCrime", ["dimCrime"], function(dimCrime){return(
dimCrime.group()
)});
  main.variable(observer("dimDay")).define("dimDay", ["facts","d3"], function(facts,d3){return(
facts.dimension(function(d){return [d.type,d3.timeDay(d.dtg)]})
)});
  main.variable(observer("groupDayCrime")).define("groupDayCrime", ["dimDay"], function(dimDay){return(
dimDay.group()
)});
  main.variable(observer("circlesLayer")).define("circlesLayer", ["L","map"], function(L,map){return(
L.layerGroup().addTo(map)
)});
  main.variable(observer("circle")).define("circle", ["circlesLayer","crimes","L","colorScale"], function(circlesLayer,crimes,L,colorScale)
{
