...
html`<code>css</code> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.0/css/bootstrap.min.css" integrity="sha384-PDle/QlgIONtM1aqA2Qemk5gPOE7wFq8+Em+G/hmo5Iq0CCmYZLv3fVRDJ4MMwEA" crossorigin="anonymous"><link rel="stylesheet" href="https://unpkg.com/leaflet@1.5.1/dist/leaflet.css"integrity="sha512-xwE/Az9zrjBIphAcBb3F6JVqxf46+CDLwfLMHloNu6KEQCAWi6HcDUbeOfBIptF7tcCzusKFjFw2yuvEpDL9wQ=="crossorigin=""/>`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["md","container","dc","dateDimension","d3","dimMag","groupMag","dimDep","groupDep","dimHour","hourGroup","earthquake"], function(md,container,dc,dateDimension,d3,dimMag,groupMag,dimDep,groupDep,dimHour,hourGroup,earthquake)
{
  ...
  let barChartDep = dc.barChart(view.querySelector("#depth-chart"))
  let lineChartTime = dc.lineChart(view.querySelector("#time-chart"))
  ...
  lineChartTime.width(960)
	  		...
	  		.group(hourGroup)
	  		.brushOn(false)
	  		.x(d3.scaleTime().domain(d3.extent(earthquake, function (d){
	  			return d.dtg;
	  		})))
	  		.elasticY(true)
...
facts.dimension(d => d.dtg)
  ...
  main.variable(observer("dimMag")).define("dimMag", ["facts"], function(facts){return(
facts.dimension(d => d.mag)
)});
  main.variable(observer("groupMag")).define("groupMag", ["dimMag"], function(dimMag){return(
dimMag.group()
)});
  main.variable(observer("dimDep")).define("dimDep", ["facts"], function(facts){return(
facts.dimension(d => d.dep)
)});
  main.variable(observer("groupDep")).define("groupDep", ["dimDep"], function(dimDep){return(
dimDep.group()
)});
  main.variable(observer("dimHour")).define("dimHour", ["facts","d3"], function(facts,d3){return(
facts.dimension( d =>d3.timeHour(d.dtg))
)});
  main.variable(observer("hourGroup")).define("hourGroup", ["dimHour"], function(dimHour){return(
dimHour.group()
)});
  main.variable(observer("circlesLayer")).define("circlesLayer", ["L","map"], function(L,map){return(
L.layerGroup().addTo(map)
)});
  main.variable(observer("circle")).define("circle", ["circlesLayer","earthquake","L"], function(circlesLayer,earthquake,L)
{
  ...
  circle.bindPopup("Magnitude: "+d.mag+'\nDepth: '+d.dep+'\nTime: '+d.dtg+'\n')})
}
);
